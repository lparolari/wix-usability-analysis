...
\author{Luca Parolari (mat. 1236601)}
\title{Web Information Management\\ \Large Analisi di usabilità del sito web \wix{}}
\date{
  \noindent \small Corso di Web Information Management \\
  \noindent Laurea Magistrale di Informatica \\
  \noindent Dipartimento di Matematica e Informatica \\
  \noindent Università di Padova \\[2ex]
  \today
}
...
\begin{abstract}
  Analisi di usabilità della versione in italiano del sito web \wix{}
  nel periodo di gennaio/febbraio 2021. (\url{https://it.wix.com}).
\end{abstract}
...
stato analizzato nel periodo di gennaio/febbraio 2021.
